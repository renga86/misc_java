...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    DListNode currnode = ((DList)myList).newNode(item, (DList)myList, this, this.next);
    this.next.prev = currnode;
    this.next = currnode;
    myList.size++;
  }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    DListNode currnode = ((DList)myList).newNode(item, (DList)myList, this.prev, this);
    this.prev.next = currnode;
    this.prev = currnode;
    myList.size++;
